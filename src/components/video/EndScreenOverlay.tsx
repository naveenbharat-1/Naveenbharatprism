...
import brandLogo from "@/assets/logo-middle.png";
 ...
 * - Shows Naveen Bharat branding instead of YouTube logo
 */
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <div className="text-white">
          <h3 className="text-xl font-bold">Naveen Bharat Prism</h3>
