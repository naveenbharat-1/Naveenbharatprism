...
import logoIcon from "@/assets/logo-banner.png";
    ...
    <footer ref={ref} className="bg-card border-t border-border py-12" style={{ paddingBottom: 'max(3rem, env(safe-area-inset-bottom))' }}>
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <img 
                ...
                style={{ opacity: 0.9 }}
              />
              <span className="font-bold text-xl text-foreground">Naveen Bharat Prism</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>info@naveenbharatprism.edu</li>
        ...
        <div className="mt-12 pt-6 border-t border-border text-center text-sm text-muted-foreground">
          © {currentYear} Naveen Bharat Prism. All rights reserved.
        </div>
      </div>
    </footer>
  );
